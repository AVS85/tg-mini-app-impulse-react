...
const ButtonMainFill = (props: SvgIconProps): JSX.Element => {
  ...
  return (
    <SvgIcon sx={{ width, height }}>
      ...
      >
        <g filter="url(#filter0_ddi_77_207)">
          <circle cx="52" cy="52" r="38" fill="url(#paint0_linear_77_207)" />
        </g>
        <path
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_77_207"
            />
            <feColorMatrix
              in="SourceAlpha"
              type="matrix"
            ...
            <feBlend
              mode="normal"
              in2="effect1_dropShadow_77_207"
              result="effect2_dropShadow_77_207"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect2_dropShadow_77_207"
              result="shape"
            />
            <feColorMatrix
              in="SourceAlpha"
            ...
            <feColorMatrix
              type="matrix"
              values="0 0 0 0 0.317647 0 0 0 0 0.968627 0 0 0 0 0.866667 0 0 0 1 0"
            />
            <feBlend
              mode="normal"
              in2="shape"
              result="effect3_innerShadow_77_207"
            />
          </filter>
          <linearGradient
            id="paint0_linear_77_207"
            x1="51.9964"
            y1="90"
            x2="51.9964"
            y2="14"
          ...
          >
            <stop stopColor="#1DE4CB" />
            <stop offset="1" stopColor="#54A3BE" />
          </linearGradient>
        </defs>
      </svg>
    </SvgIcon>
